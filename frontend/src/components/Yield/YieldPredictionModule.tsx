          ...
          <div className="bg-white rounded-2xl p-5 border border-emerald-200 shadow-xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-gray-800">Interactive Sensitivity Simulator</h3>
                  <p className="text-xs text-gray-500">Adjust Nitrogen or soil moisture inputs to see real-time predicted yield boost</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
              ...
              <div className="space-y-2 p-3 bg-gray-50 rounded-xl border border-gray-100">
                <div className="flex items-center justify-between text-xs font-bold">
                  <span>Soil Moisture (soil_moisture_pct)</span>
